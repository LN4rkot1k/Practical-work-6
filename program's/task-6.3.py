...
my_module.hello_world('Олег')  # Вызовите функцию hello_world из модуля my_module
...
print(hello_world("Олег"))  # Функция hello_world должна вызываться без указания модуля
